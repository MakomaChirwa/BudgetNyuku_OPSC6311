...
class ExpenseListActivity : AppCompatActivity() {
    ...
    private fun loadExpenses() {
        ...
        findViewById<TextView>(R.id.tvTotalAmount).text = String.format("Total: R%.2f", totalAmount)
        findViewById<TextView>(R.id.tvDateRange).text = "$currentStartDate to $currentEndDate"
    ...
    private fun showExpenseDetails(expense: Expense) {
        ...
        view.findViewById<TextView>(R.id.tvAmount).text = String.format("R%.2f", expense.amount)
        view.findViewById<TextView>(R.id.tvDate).text = expense.date
        view.findViewById<TextView>(R.id.tvTime).text = "${expense.startTime} - ${expense.endTime}"
