...
class Dashboard : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        // Add these click listeners in your Dashboard activity
        findViewById<androidx.cardview.widget.CardView>(R.id.cardAddIncome).setOnClickListener {
            startActivity(Intent(this, AddIncomeActivity::class.java).putExtra("USER_ID", userId))
        }

        findViewById<androidx.cardview.widget.CardView>(R.id.cardAddInvestment).setOnClickListener {
            startActivity(Intent(this, AddInvestmentActivity::class.java).putExtra("USER_ID", userId))
        }
